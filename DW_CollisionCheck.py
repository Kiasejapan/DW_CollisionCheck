...
def ml_compute_landing(source_shapes, target_shapes, axis, sign, offset,
    ...
    #                  user's selection. Partial / fully static triangles
    #                  are excluded entirely; the unmoving mesh data is
    #                  NOT used for collision detection at all.
    src_moving_tris = []
    for shape in source_shapes:
